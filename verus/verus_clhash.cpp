...
#define verus2_2round(randomsource,fixrand,fixrandex,g_prand,g_prandex,pbuf,pbuf_copy,acc,round) {\
	...
	_mm_store_si128(&g_prand[round], prand[0]);\
	_mm_store_si128(&g_prandex[round], prandex[0]);\
	fixrand[round] = prand_idx;\
	fixrandex[round] = prandex_idx;\
...
inline u128 __verusclmulwithoutreduction64alignedrepeatv2_2(u128 *randomsource, const u128 buf[4], uint32_t *fixrand, uint32_t *fixrandex, u128 *g_prand, u128 *g_prandex)
{
	...
	{
		verus2_2round(randomsource,fixrand,fixrandex,g_prand,g_prandex,pbuf,pbuf_copy,acc,i);
	}*/
	#if 1
...
uint64_t verusclhashv2_2(void * random, const unsigned char buf[64],uint32_t *fixrand, uint32_t *fixrandex, u128 *g_prand, u128 *g_prandex) {
	u128  acc = __verusclmulwithoutreduction64alignedrepeatv2_2((u128 *)random, (const u128 *)buf, fixrand, fixrandex, g_prand, g_prandex);
